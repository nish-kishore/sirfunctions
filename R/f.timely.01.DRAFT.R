...
# It makes the timeliness function----
f.timely.01 <- function(
  ...
  afp.data1 = afp.data %>%
    mutate(ontonot = afp.data1$date.notify - afp.data1$date,
           nottoinvest = afp.data1$date.invest - afp.data1$date,
           investtostool1 = afp.data1$datestool1 - afp.data1$date,
...
huh = f.timely.01(ctry.data$afp.all.2, dpop.ctry, date_first, date_last, "dist")