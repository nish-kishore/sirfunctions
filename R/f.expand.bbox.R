#' Expand bounding box
#'
#' (_Sourced from_ https://rdrr.io/github/Chrisjb/basemapR/src/R/expand_bbox.R)
#' A function to take a bounding box (generated using st_bbox) and expand it by x meters
#' in the X direction and y meters in the Y direction.
#'
#' @import sf
#' @param bbox `num vector` A bounding box generated by `sf::st_bbox()` or named numeric `vector` with xmin, ymin, xmax, ymax.
...
#'
#' @return A named numeric vector of bbox extents. This can be converted into an `sf` object using `sf::st_as_sfc()`.
#' @examples
