test_that("Testing f.timely.detection.01()", {
  ...
  country_data <- sirfunctions::extract_country_data(.country = country,
                                                     .raw.data = raw.data)
  ...
  expect_no_error(f.timely.detection.01(afp.data = afp_data,
                                        es.data = es_data,
  ...
  expect_error(f.timely.detection.01(afp.data = afp_data,
                                     es.data = es_data,
                                     ctryseq.data = cntryseq_data,
